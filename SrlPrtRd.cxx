...
// #include </usr/includes/libserial/SerialPort.h>
...
int srlPrtRd(char *srlPrt)
{
    ...
    try
    {
        ...
        std::cout << "try to open serial port:" << srlPrt << std::endl;
        serial_port.Open(srlPrt) ;
    }
    ...
    catch (const ReadTimeout&)
    {
        ...
        {
            std::cout << read_buffer.at(i) << std::endl;
        }

        std::cerr << read_buffer.at(1) << std::endl ;
